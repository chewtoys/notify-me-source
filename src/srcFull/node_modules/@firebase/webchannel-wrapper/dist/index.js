(function() {
    ...
    function r(a, b, c) {
        Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ? r = ha : r = ia;
    ...
    hb.prototype.add = function(a, b, c, d, e) {
        ...
        a = this.a[f];
        a || (a = this.a[f] = [], this.b++);
        var h = ib(a, b, d, e); - 1 < h ? (b = a[h], c || (b.ba = !1)) : (b = new fb(b, this.src, f, !!d, e), b.ba = c, a.push(b));
        return b
    };
    ...
    function qb(a, b, c, d, e, f) {
        ...
        d.src = a;
        d.listener = c;
        if (a.addEventListener) ab || (e = h), void 0 === e && (e = !1), a.addEventListener(b.toString(), d, e);
        else if (a.attachEvent) a.attachEvent(tb(b.toString()), d);
    ...
    function vb(a, b, c, d, e) {
        ...
        else(d = ea(d) ? !!d.capture : !!d, c = pb(c), a && a[db]) ? (a = a.f, b = String(b).toString(), b in a.a && (f = a.a[b], c = ib(f, c, d, e), -1 < c && (gb(f[c]), Array.prototype.splice.call(f, c, 1), 0 == f.length && (delete a.a[b], a.b--)))) : a && (a = rb(a)) && (b = a.a[b.toString()], a = -1, b && (a = ib(b, c, d, e)), (c = -1 < a ? b[a] : null) && wb(c))
    }
    ...
    g.dispatchEvent = function(a) {
        ...
        e = Ab(h, d, !1, a) && e;
        if (b)
            for (f = 0; f < b.length; f++) h = a.a = b[f], e = Ab(h, d, !1, a) && e;
        return e
    };
    g.w = function() {
        B.H.w.call(this);
        ...
        if (null == b) c.push("null");
            ...
            if ("object" == typeof b) {
                ...
                if (b instanceof String || b instanceof Number || b instanceof Boolean) b = b.valueOf();
                    ...
                    c.push("{");
                    e = "";
                    for (d in b) Object.prototype.hasOwnProperty.call(b, d) && (f = b[d], "function" != typeof f && (c.push(e), Gb(d, c), c.push(":"), Eb(a, f, c), e = ","));
                    c.push("}");
                    return
                }
            }
    ...
    function Ub() {
        if (-1 != String(k.Promise).indexOf("[native code]")) {
            ...
            var a = Vb;
            !da(k.setImmediate) || k.Window && k.Window.prototype && !y("Edge") && k.Window.prototype.setImmediate == k.setImmediate ? (Rb || (Rb = Sb()), Rb(a)) : k.setImmediate(a)
        }
    }
    var Wb = !1,
        Pb = new Kb;
    ...
    g.qb = function() {
        if (this.ea) {
            var a = t() - this.g;
            0 < a && a < .8 * this.b ? this.O = this.a.setTimeout(this.c, this.b - a) : (this.O && (this.a.clearTimeout(this.O), this.O = null), this.dispatchEvent("tick"), this.ea && (this.O = this.a.setTimeout(this.c, this.b), this.g = t()))
        }
    };
    g.start = function() {
        this.ea = !0;
    ...
    hc.prototype.log = function(a, b, c) {
        if (a.value >= nc(this).value)
            for (da(b) && (b = b()), a = new fc(a, String(b), this.f), c && (a.a = c), c = this; c;) c = c.a
    };
    var oc = {},
        pc = null;
    ...
    function Xc(a, b) {
        ...
        b = a.j ? Fa(a.j) : {};
        a.l ? (a.o || (a.o = "POST"), b["Content-Type"] = "application/x-www-form-urlencoded", a.a.fa(a.g, a.o, a.l, b)) : (a.o = "GET", a.a.fa(a.g, a.o, null, b));
        Ac(1);
    ...
    function ad(a) {
        ...
        if (!(3 > b || 3 == b && !Na && !a.a.V())) {
            ...
            if (a.f) {
                if (d = cd(a)) G(a.b, a.c, d, "Initial handshake response via X-HTTP-Initial-Response"), a.v = !0, dd(a, d);
                a.K ? (ed(a, b, c), Na && a.f && 3 == b && fd(a)) : (G(a.b, a.c, c, null), dd(a, c));
                4 == b && gd(a);
                a.f && !a.B && (4 == b ? a.i.ta(a) : (a.f = !1, Zc(a)))
            } else 400 ==
                e && 0 < c.indexOf("Unknown SID") ? (a.m = 3, K(12), D(a.b.a, "XMLHTTP Unknown SID (" + a.c + ")")) : (a.m = 0, K(13), D(a.b.a, "XMLHTTP Bad status " + e + " (" + a.c + ")")), gd(a), hd(a)
        }
    }
    ...
    g.lb = function() {
        this.s = null;
        var a = t();
        0 <= a - this.U ? (this.f && J(this.b, "Received watchdog timeout even though request loaded successfully"), wc(this.b, this.g), 2 != this.J && (Ac(3), K(17)), gd(this), this.m = 2, hd(this)) : (D(this.b.a, "WatchDog timer called too early"), kd(this, this.U - a))
    };
    ...
    function md(a, b) {
        ...
        else if (ca(a) || l(a)) ra(a, b, void 0);
        else {
            if (a.M && "function" == typeof a.M) var c = a.M();
    ...
    function O(a, b) {
        ...
        if (1 < c) {
            ...
            if (a instanceof O)
                for (c = a.M(), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
            else
    ...
    function Q(a, b) {
        ...
        this.h = !1;
        var c;
        a instanceof Q ? (this.h = void 0 !== b ? b : a.h, sd(this, a.f), this.j = a.j, td(this, a.b), ud(this, a.i), this.a = a.a, vd(this, wd(a.c)), this.g = a.g) : a && (c = String(a).match(qd)) ? (this.h = !!b, sd(this, c[1] || "", !0), this.j = xd(c[2] || ""), td(this, c[3] || "", !0), ud(this, c[4]), this.a = xd(c[5] || "", !0), vd(this, c[6] || "", !0), this.g = xd(c[7] || "")) : (this.h = !!b, this.c = new yd(null, this.h))
    }
    Q.prototype.toString = function() {
        ...
        b && a.push(zd(b, Ad, !0), ":");
        var c = this.b;
        if (c || "file" == b) a.push("//"), (b = this.j) && a.push(zd(b, Ad, !0), "@"), a.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), c = this.i, null != c && a.push(":", String(c));
        if (c = this.a) this.b && "/" != c.charAt(0) && a.push("/"), a.push(zd(c, "/" == c.charAt(0) ? Bd : Cd, !0));
    ...
    g.M = function() {
        S(this);
        for (var a = this.a.A(), b = this.a.M(), c = [], d = 0; d < b.length; d++)
    ...
    g.A = function(a) {
        S(this);
        var b = [];
        if (l(a)) Md(this, a) && (b = va(b, this.a.get(Kd(this, a))));
        else {
            a = this.a.A();
    ...
    function Sd(a) {
        ...
        }), K(4), b ? (K(10), Td(a.a, a, !1)) : (K(11), Td(a.a, a, !0));
        else {
    ...
    g.Oa = function(a, b) {
        ...
        if (0 == this.P) {
            ...
            if (K(5),
                this.h = !0, !z || 10 <= Number(Wa)) this.f = 200, this.c.cancel(), H(this.b, "Test connection succeeded; using streaming connection"), K(11), Td(this.a, this, !0)
        } else K(7), this.h = !1
    };
    g.ta = function() {
        this.f = this.c.C;
        this.c.f ? 0 == this.P ? (this.P = 1, H(this.b, "TestConnection: request complete for initial check"), Sd(this)) : 1 == this.P && (H(this.b, "TestConnection: request complete for stage 2"), this.h ? (H(this.b, "Test connection succeeded; using streaming connection"), K(11), Td(this.a, this, !0)) : (H(this.b, "Test connection failed; not using streaming"), K(10), Td(this.a, this, !1))) : (H(this.b, "TestConnection: request failed, in state " + this.P), 0 == this.P ? K(8) : 1 == this.P && K(9), Vd(this.a, this))
    };
    g.ia = function() {
        return this.a.ia()
    };
    ...
    function $d(a) {
        this.g = a || ae;
        k.PerformanceNavigationTiming ? (a = k.performance.getEntriesByType("navigation"), a = 0 < a.length && ("hq" == a[0].nextHopProtocol || "h2" == a[0].nextHopProtocol)) : a = !!(k.oa && k.oa.Ma && k.oa.Ma() && k.oa.Ma().Jb);
        this.f = a ? this.g : 1;
        this.a = null;
    ...
    g.fa = function(a, b, c, d) {
        ...
        try {
            re(this), 0 < this.l && (this.v = se(this.a), E(this.b, U(this, "Will abort after " + this.l + "ms if incomplete, xhr2 " + this.v)), this.v ? (this.a.timeout =
                this.l, this.a.ontimeout = r(this.Ka, this)) : this.C = Zb(this.Ka, this.l, this)), E(this.b, U(this, "Sending request")), this.u = !0, this.a.send(a), this.u = !1
        } catch (f) {
    ...
    function ve(a) {
        if (a.c && "undefined" != typeof goog)
            if (a.D[1] && 4 == N(a) && 2 == a.W()) E(a.b, U(a, "Local request error detected and ignored"));
            else if (a.u && 4 == N(a)) Zb(a.Na, 0, a);
    ...
    function ye(a) {
        ...
        this.wa = n("internalChannelParams.forwardChannelRequestTimeoutMs",
            a) || 2E4;
        ...
        (this.va = a && a.fastHandshake || !1) && !this.o && (D(this.a.a, "Force backgroundChannelTest when fastHandshake is enabled."), this.o = !0);
        a && a.Fa && this.a.Fa()
    }
    g = ye.prototype;
    g.na = 8;
    ...
    function Ge(a, b) {
        var c = a.c;
        if ((c.b ? 1 : c.a ? c.a.a.c : 0) >= a.c.f - (a.m ? 1 : 0)) return J(a.a, "Unexpected retry request is scheduled."), !1;
        if (a.m) return H(a.a, "Use the retry request that is already scheduled."), a.g = b.u.concat(a.g), !0;
    ...
    g.Qa = function(a) {
        ...
        if (1 == this.F)
            if (a) J(this.a, "Not supposed to retry the open");
            else {
                H(this.a, "open_()");
                this.R = Math.floor(1E5 * Math.random());
                a = this.R++;
                var b = new L(this, this.a, a, void 0),
                    c = this.i;
                ...
                ce(this.c, b);
                this.va ? (R(e, "$req", d), R(e, "SID", "null"),
                    b.X = !0, Vc(b, e, null)) : Vc(b, e, d);
                this.F = 2
            }
    ...
    function Ie(a, b) {
        var c = Math.min(a.g.length, 1E3),
            d = a.f ? r(a.f.ab, a.f, a) : null;
        a: for (var e = a.g, f = -1;;) {
            var h = ["count=" + c]; - 1 == f ? 0 < c ? (f = e[0].a, h.push("ofs=" + f)) : f = 0 : h.push("ofs=" + f);
            for (var m = !0, v = 0; v < c; v++) {
                var I = e[v].a,
                    X = e[v].b;
                I -= f;
                if (0 > I) f = Math.max(0, e[v].a - 100), m = !1;
                else try {
                    ke(X, h, "req" + I + "_")
                } catch (Mb) {
                    d && d(X)
    ...
    g.Oa = function(a, b) {
        if (0 != this.F && (this.b == a || ee(this.c, a)))
            if (this.u = a.C, !a.v && ee(this.c, a) && 3 == this.F) {
                try {
                ...
                if (p(c) && 3 == c.length)
                    if (b = c, 0 == b[0]) a: if (H(this.a, "Server claims our backchannel is missing."), this.l) H(this.a, "But we are currently starting the request.");
                        else {
                            if (this.b)
                                if (this.b.D + 3E3 < a.D) De(this), this.b.cancel(), this.b = null;
                                else break a;
                            else D(this.a.a, "We do not have a BackChannel established");
                            Le(this);
                            K(18)
                        }
                else this.xa = b[1], a = this.xa - this.N,
                    0 < a && (b = b[2], H(this.a, b + " bytes (in " + a + " arrays) are outstanding on the BackChannel"), 37500 > b && this.ka && 0 == this.B && !this.s && (this.s = Ec(r(this.ib, this), 6E3)));
                else H(this.a, "Bad POST response data returned"), V(this, 11)
            } else if ((a.v || this.b == a) && De(this), !xa(b))
            for (b = c = this.la.a.parse(b), c = 0; c < b.length; c++) {
                var d = b[c];
                this.N = d[0];
                d = d[1];
                if (2 == this.F)
                    if ("c" == d[0]) {
                        ...
                        this.o && (d = a.a) && ((e = id(d, "X-Client-Wire-Protocol")) && be(this.c, e), this.j && ((d = id(d, "X-HTTP-Session-Id")) ? (this.K = d, R(this.D, this.j, d)) : D(this.a.a, "Missing X_HTTP_SESSION_ID in the handshake response")));
                        this.F = 3;
                        this.f && this.f.Da();
                        d = a;
                        this.ua = Ud(this, this.X, this.ja);
                        d.v ? (H(this.a, "Upgrade the handshake request to a backchannel."), fe(this.c, d), (e = this.G) && d.setTimeout(e), d.s && (bd(d), Zc(d)), this.b = d) :
                            Ke(this)
    ...
    g.ta = function(a) {
        ...
        if (this.b == a) {
            ...
            this.b = null;
            var c = 2
        } else if (ee(this.c, a)) b = a.u, fe(this.c, a), c = 1;
        else return;
        this.u = a.C;
        if (0 != this.F)
            if (a.f) 1 == c ? (Dc(a.l ? a.l.length : 0, t() - a.D, this.v), Fe(this)) : Ke(this);
            else {
                var d = a.m;
                if (3 == d || 0 == d && 0 < this.u) H(this.a, "Not retrying due to error type");
                else {
                    var e = this;
                    H(this.a, function() {
    ...
    function V(a, b) {
        ...
        if (2 == b) {
            ...
            a.f && (c = null);
            var d = r(a.pb, a);
            c || (c = new Q("//www.google.com/images/cleardot.gif"), k.location && "http" == k.location.protocol || sd(c, "https"), Wc(c));
            le(c.toString(), d)
        } else K(2);
    ...
    function Ce(a) {
        ...
        if (a.f) {
            var b = ge(a.c);
            if (0 != b.length || 0 != a.g.length) H(a.a, function() {
    ...
    function W(a, b) {
        ...
        (b = b && b.httpSessionIdParam) && !xa(b) && (this.a.j = b, a = this.g, null !== a && b in a && (a = this.g, b in a && delete a[b], D(this.c, "Ignore httpSessionIdParam also specified with messageUrlParams: " + b)));
        this.h = new Re(this)
    }
    u(W, B);
    g = W.prototype;
    ...
    g.fb = function() {
        ...
        K(3);
        c = a.a.I.b;
        null != c ? (a.g = c[0], a.P = 1, Sd(a)) : ($c(b, "MODE", "init"), !a.a.o && a.a.j && $c(b, "X-HTTP-Session-Id", a.a.j), a.c = new L(a, a.b, void 0, void 0), a.c.j = a.i, Yc(a.c, b, !1,
            null), a.P = 0)
    };
    g.close = function() {
        ze(this.a)
