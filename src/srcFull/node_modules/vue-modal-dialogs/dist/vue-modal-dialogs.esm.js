...
var DialogsWrapper = {
    ...
    methods: {
        ...
        add: function add(dialogData, args) {
            ...
            var instancePromise = new Promise(function(res) {
                dialogData.createdCallback = res;
            });
            ...
            var finalPromise = dialogData.component.then(function(component) {
                ...
                var renderOptions = Object.freeze({
                    id: id,
                    propsData: propsData,
                    component: component,
                    close: close,
...
function generateDialogData(props, component) {
    ...
    return dialogData = {
        ...
        component: Promise.resolve(component).then(function(component) {
            return ({
                extends: component.default || component,
                props: filterUndefinedProps(['arguments'].concat(props), component),
                created: function created() {
