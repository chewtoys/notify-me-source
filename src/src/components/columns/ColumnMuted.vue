        ...
        <div class=" notified_info">
            <div class="info_items">
                <div class="info_item">
                    ...
                    <div class="stat_label">MUTED</div>
                </div>
            </div>
...
export default {
    ...
    computed: {
        ...
        content: {
            get() {
                const columnData = this.$store.getters.getMuted
            ...
            set(value) {
                ...
                if (this.identicalCheck.length !== value.length)
                    Channel.mute(this.$store.state.draggedElementData.id)
                        .then(res => {
                            // this.$root.$emit('alert', 'success', 'Muted channel!')
                        })
                        .catch(e => {
                            this.$root.$emit('alert', 'error', 'Failed to mute channel')
                        })
            }
        }
    }
